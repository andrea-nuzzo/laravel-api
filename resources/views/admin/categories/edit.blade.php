                        ...
                        <div class="card-body rounded border border-dark mb-3"> 
                            <form action="{{route("categories.update", $category->id)}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Add name category" value="{{old('name') ? old('name') : $category->name }}">
                                    @error('name')
